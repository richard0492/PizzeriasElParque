                ...
                <center>
                    ...
                    <asp:DropDownList ID="dlEmployees" CssClass="custom-select" runat="server" Height="40px" Width="257px" Font-Size="Medium"></asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox type="number" CssClass="form-control" ID="Identification" runat="server" placeholder="Ejemplo:101110011" title="Digite el número de cédula con números seguidos y con división de ceros ejemplo:101110111" BorderColor="Blue" Font-Bold="True" Font-Names="Lucida Sans" Enabled="False"></asp:TextBox>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox type="number" CssClass="form-control" ID="TypeUser" runat="server"  title="Indica el tipo de usuario que se desa dehabilitar del sistema" BorderColor="Blue" Font-Bold="True" Font-Names="Lucida Sans" Enabled="False"></asp:TextBox>
                            <br>
                            <br>
                        </div>
                        <br />
            <br />
            <asp:LinkButton ID="btnDisable" runat="server" class="btn btn-default btn-lg, btn btn-primary" OnClick="btbDisable_Click" BackColor="Blue" Font-Bold="True" Font-Size="Medium" Height="49px" Width="162px"><i class="fa fa-plus"></i> Deshabilitar</asp:LinkButton>
            <br />
            <br />
            <br />
                    </div>
