                    ...
                    <div style="border: 2px solid #0000FF; text-align:center; width:90%; padding: 10px 10px; box-sizing: border-box;
                     background: rgba(0,0,0,.1);" class="form-inline" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <br />
                            <asp:DropDownList CssClass="form-control" ID="DropDownListPreparationTime" runat="server" Font-Bold="True" Font-Names="Lucida Sans" Enabled="False" >
                            ...
                            <asp:TextBox type="number" CssClass="form-control" ID="txtPrice" runat="server" BorderColor="Blue" Font-Bold="True" Font-Names="Lucida Sans" Enabled="False"></asp:TextBox>
                            &nbsp;<label for="name" style="font-size: medium; font-family: Verdana, Geneva, Tahoma, sans-serif; color: #000000;">colones.</label></div>
                        </div>
                        <br />
            <br />
            <asp:LinkButton ID="btnDisable" runat="server" class="btn btn-default btn-lg, btn btn-primary"  BackColor="Blue" Font-Bold="True" Font-Size="Medium" Height="49px" Width="139px" OnClick="btnDisable_Click"><i class="fa fa-plus"></i> Deshabilitar</asp:LinkButton>
            <br />
            <br />
            <br />
                    </div>
